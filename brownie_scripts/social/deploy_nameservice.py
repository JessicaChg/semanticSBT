...
def deploy_transparentUpgradeableProxy(logic_address, proxy_admin, data):
    account = get_account()
    ...
    update_address("nameService_transparent_upgradeable_proxy", transparent_upgradeable_proxy)
...
def deploy_name_service_fully():
    ...
    deploy_transparentUpgradeableProxy(logic_address, proxy_admin, init_data)
